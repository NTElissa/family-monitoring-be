...
app.get('/', (req, res) => {
  res.status(200).send(`<h1 style='text-align: center; color: #CCD6F6; margin-top: 20vh; background: #F8B205; padding: 150px;'>Welcome to  Online Family Expenses Monitoring System Proj apis</h1>`);
});
