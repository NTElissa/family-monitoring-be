...
exports.newIncome = exports.getAllIncomes = exports.deleteIncomeById = exports.deleteAllIncomes = void 0;
...
const newIncome = async (req, res) => {
  ...
  try {
    ...
    const income = await Income.create({
      ...
      //  + " " + user.last_name, // Assign creatorName
    ...
    return res.status(201).json({
      ...
      income: {
        ...
        creatorName: income.creatorName,
...
exports.deleteAllIncomes = deleteAllIncomes;